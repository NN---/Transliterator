    ...
    WORD wLanguage)
{
    ...
    hrRes=FindResourceExA(hModule, lpType, lpName, wLanguage);
    ...
    WORD wLanguage)
{
    ...
    hrRes=FindResourceExW(hModule, lpType, lpName, wLanguage);
    ...
    BOOL bIcon)
{
    ...
    hrIcon=FindResourceExA(hInstance,
        MAKEINTRESOURCEA(iid),
        bIcon ? (LPCSTR)RT_ICON : (LPCSTR)RT_CURSOR, wLanguage);
    ...
    BOOL bIcon)
{
    ...
    hrIcon=FindResourceExW(hInstance,
        MAKEINTRESOURCEW(iid),
        bIcon ? (LPCWSTR)RT_ICON : (LPCWSTR)RT_CURSOR, wLanguage);
