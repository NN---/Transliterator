...
public:
	...
	NN::auto_value<BOOL,TRUE> m_bFiles;
	NN::auto_value<BOOL,FALSE> m_bFolders;
	NN::auto_value<BOOL,FALSE> m_bSubFolders;
	NN::auto_value<BOOL,FALSE> m_bThisFolder;
	NN::auto_value<BOOL,TRUE> m_bName;
	NN::auto_value<BOOL,FALSE> m_bEntry;
	NN::auto_value<BOOL,FALSE> m_bMP3Tags;
	NN::auto_value<Translate::Direction,Translate::dirTrnstoRus> m_nDirection;
